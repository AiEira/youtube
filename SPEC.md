...
> *寫給未來的維護者。如果你要從零重建這個項目，這份文件告訴你每一個決策背後的「為什麼」——不只是怎麼做，更是踩過哪些坑、學到哪些教訓。*
>
> 版本：1.0 — 2026-05-21
...
- **模型鎖定** `mlx-community/whisper-large-v3-mlx`——medium 模型雖然快但準確度明顯下降，違反「品質勝於速度」原則
